...
export default function EventSignals() {
  ...
  // `onUpdate` below, a single edit reads as a stream:
  // startEdit → submitEdit → commitEdit, then
  // updateSuccess (or updateError) once the async save settles.
  ...
  // Settle after a random 0.5–3 s, then fail 1 in 4 saves — so
  // the stream mixes updateSuccess (green) and updateError (red)
  // at unpredictable delays.
