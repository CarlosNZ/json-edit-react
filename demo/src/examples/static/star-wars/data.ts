// Star Wars data scraped from The Star Wars API
// (https://swapi.info/). Large, deeply-nested sample
// data used to demonstrate filter-function editing
// restrictions plus date-picker and hyperlink custom
// components.
export const data = {
  name: 'Luke Skywalker',
  height: 172,
