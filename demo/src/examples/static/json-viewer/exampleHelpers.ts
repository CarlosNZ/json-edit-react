// A rich, deeply-nested reference document for the read-only viewer
// — pure filler data, kept out of the example file so it stays about
// `JsonViewer`, not the solar system.
