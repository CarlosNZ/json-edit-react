...
//
// Without an argument, writes to `massive-test-data.json` in the repo root.
...
const DEFAULT_OUTPUT = resolve(REPO_ROOT, 'massive-test-data.json')
...
function makeKingdom() {
  return {
    ...
    provinces: Array.from({ length: range(5, 8) }, makeProvince),
...
function makeRealm() {
  return {
    ...
    kingdoms: Array.from({ length: 6 }, makeKingdom),
