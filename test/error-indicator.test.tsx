...
// the memo boundary, so only the customNodeDefinitions identity (memoized on
// `validation`) piercing the memo can re-render it. Mirrors the #359
// cross-branch test, proven here through the component.
