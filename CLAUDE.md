...
| [style.css](src/style.css) + [injectStyles.ts](src/injectStyles.ts) | Bundled CSS (inlined as a string by `rollup-plugin-styles`) and the injector that puts it in `<head>` |
