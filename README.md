...
- Leaving an open edit to start another — by pressing `Tab`, or by clicking/double-clicking a different node — **saves** the current edit (the same as confirming it); use `Escape` (or the ✗ button) to discard it instead
