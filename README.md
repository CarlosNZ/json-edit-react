...
| `arrayIndexStart`       | `0 \| 1`                                  | `0`                  | The number the *first* array element's index label starts from. `0` (default) gives `0, 1, 2…`; `1` gives `1, 2, 3…`. (Internally accepts any number, so other offsets are possible if you really want them.)                                                                                                                                                                                              |
